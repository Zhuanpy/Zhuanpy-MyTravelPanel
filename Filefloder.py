...
#     base_path = r'E:\WORKING\A-AIR_TICKET\01_Visa'
#     requirements_folder = os.path.join(base_path, 'VisaDocumentRequirements')
#
#     @classmethod
#     def copy_folder_contents(cls, source_folder: str, destination_folder: str, excluded_folders: list = None):
#         """
...
#
#             # 检查是否需要排除该文件夹
#             if os.path.isdir(source_path) and filename not in excluded_folders:
#                 # 如果是文件夹，递归调用函数
