...
from .code.routes_visa import visa_blue
from .code.route_flight import flight_blue
from .code.routes_files import files_blue
from .code.routes_statement import statement_blue
